      ...
      <div class="page page-left flex justify-center items-center">
        <div class="w-4/5 h-5/6 flex flex-col gap-4">
          <div class="relative flex justify-center h-1/2 w-full">
            ...
            <img
class="bg-center bg-cover max-w-4/5 h-auto p-1 bg-white rounded-sm"
              :src="clubData.image" alt="">
          </div>
          <div class="scroll w-full h-1/2 bg-white p-2 overflow-auto">
...
import data from './clubIntro.json';

const route = useRoute();
const name = route.params.name as string;

const clubData = ref(data[name]);
</script>
